...
% Hierarchia ¼róde³ wsadze screena z xlinxa \n
//schemat wsadze screena z xlinxa
//
 Projekt zosta³ rozdzielony na poszczególne modu³y. Wprowadzenie modularyzacji umo¿liwi³o wyszczególnienie poszczególnych fragmentów, które s³u¿± do konkretnych celów. Zatem w projekcie wystêpuj± poni¿sze elementy: 
\begin{itemize}
	\item Modu³ inicjalizacji - jest odpowiedzialny za wysy³anie danych inicjalizacyjnych do wy¶wietlacza w odpowiedniej czêstotliwo¶ci. Jest to konieczne do ustabilizowania po³±czenia interfejsu czterobitowego. Modu³ posiada nastêpuj±ce wej¶cia i wyj¶cia:
		\begin{itemize}
			\item 
		\end{itemize}
	\item Modu³ konfiguracji -  oczekuje na sygna³ start, nastêpnie rozpoczyna przesy³anie warto¶ci konfiguruj±cych wy¶wietlacz.
		\begin{itemize}
			\item wej¶cie zegarowe
			\item 
		\end{itemize}
	\item Multiplekser \texttt{4b\_2\_1} Modu³ ten by³ konieczny aby prze³±czyæ magistralê przesy³aj±c± dane do LCD. Pocz±tkowo modu³ wysy³aj±cy pó³bajty pobiera³ dane z modu³u inicjlizacji, 
	\item Modu³ wysy³aj±cy pó³bajty
	\item Modu³ wysy³aj±cy bajty
\end{itemize}
