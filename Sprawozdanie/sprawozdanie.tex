...
\subsection{Rozmiar uk³adu}
	Poni¿ej przedstawiono raporty wygenerowane przez ¶rodowisko XLinx podczas generowania implementacji. Widaæ z niej, ¿e projekt wymaga jedynie 168 LUT spo¶ród 9312 dostêpnych.
	\begin{figure}[H]
		\centering
